...
function UploadResume() {
  ...
  const renderProjects = (projects) => {
    ...
    return projects.map((project, index) => (
      <div key={index} className="bg-gray-50 p-4 rounded-lg mb-3">
        <h4 className="font-semibold text-gray-800">{project.name || "Project Name"}</h4>
        <p className="text-gray-600 text-sm mb-2">{project.description || "No description available"}</p>
        {project.technology && (
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-8">
      ...
      <div className="text-center mb-8">
        <h1 className="text-4xl font-bold text-gray-800 mb-4">Resume Manager</h1>
          ...
          {isLoading ? (
            ...
            <div className="space-y-6 max-h-96 overflow-y-auto">
              ...
              <div className="bg-gradient-to-r from-blue-50 to-indigo-50 p-4 rounded-lg border border-blue-200">
                <h3 className="text-xl font-bold text-gray-800 mb-2">{resumeData.fname || "User"}</h3>
                <div className="space-y-1 text-sm text-gray-600">
                  {resumeData.email && <p>📧 {resumeData.email}</p>}
                  {resumeData.linkedin_url && (
                    <p>💼 <a href={resumeData.linkedin_url} target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">LinkedIn Profile</a></p>
                  )}
                  {resumeData.github_url && (
                    <p>🔗 <a href={resumeData.github_url} target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">GitHub Profile</a></p>
                  )}
                </div>
              </div>
              ...
              {resumeData.projects && resumeData.projects.length > 0 && (
                <div>
                  <h3 className="text-lg font-semibold text-gray-800 mb-3 flex items-center">
                    <span className="bg-orange-100 p-2 rounded-full mr-2">🚀</span>
                    Projects
                  </h3>
            ...
            <div className="text-center py-12">
              ...
              <h3 className="text-lg font-semibold text-gray-600 mb-2">No Resume Found</h3>
      ...
      <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="text-center p-6 bg-white rounded-lg shadow-md border border-gray-200">
          ...
          <p className="text-gray-600">Get personalized interview questions based on your resume content</p>
        </div>
        ...
        <div className="text-center p-6 bg-white rounded-lg shadow-md border border-gray-200">
          ...
          <p className="text-gray-600">Track your interview performance and get detailed feedback</p>
        </div>
        ...
        <div className="text-center p-6 bg-white rounded-lg shadow-md border border-gray-200">
          ...
          <h3 className="text-lg font-semibold text-gray-800 mb-2">Skill Improvement</h3>
          <p className="text-gray-600">Identify areas for improvement and enhance your interview skills</p>
        </div>
      </div>
    </div>
  );
